...
<div class="descrEv">
    ...
    <h3>Majorat</h3>
    <p>Abia astepti momentul in care vei implini 18 ani? Iti doresti o seara spectaculoasa 
        pe care toti prietenii tai sa o tina minte? Apeleaza la specialistii in organizare 
        petrecere majorat si vei avea evenimentul pe care il visezi de multa vreme! 
</p>
<p>
iua in care devii major nu se uita niciodata, asa ca trebuie sa fie perfecta! Toti adolescentii
 asteapta cu nerabdare sa implineasca frumoasa varsta de 18 ani, iar cand acest lucru se 
 intampla, isi doresc ca petrecerea lor sa fie de neuitat.</p>
 <p>
 Meriti o petrecere majorat formidabila, iar specialistii nostri o vor organiza de la A la Z,
  cu o atentie sporita pentru detalii. Te vei bucura de preparate delicioase, bauturi cool,
   muzica vibranta si distractie cat incape!</p>
</div>
<div class="imgtop">
        <img class="imagheaderdreapta"  src="images/majorat.jpeg" alt="majorat">
    </div>
</div>
...
<label><input type="date" name="date">Data majoratului</label>
...
<input type="checkbox" name="event" checked hidden value="majorat">
...
switch($_GET["error"]){
    ...
    case "invaliddate": echo "Data majoratului trebuie sa fie peste cel putin 1 saptamana de la data actuala";break; 
}    
}
?>
</div>
